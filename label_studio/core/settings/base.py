...
DATA_UPLOAD_MAX_MEMORY_SIZE = int(
    get_env("DATA_UPLOAD_MAX_MEMORY_SIZE", 3000 * 1024 * 1024)
)
...
if ENABLE_CSP := get_bool_env("ENABLE_CSP", True):
    ...
    CSP_CONNECT_SRC = (
        ...
        "https://*.googletagmanager.com",
        "https://*.g.double"
        + "click.net",  # hacky way of suppressing codespell complaint
...
REDIS_SSL_SETTINGS = {
    "ssl_cert_reqs": (
        None if _REDIS_SSL_CERTS_REQS.lower() == "none" else _REDIS_SSL_CERTS_REQS
    ),
